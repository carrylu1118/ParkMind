...
CREATE TABLE `notice` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='校园墙';
...
(22, 'notice', '校园墙', 'document_ids', '', 'Notice', 'crud', 'com.ruoyi.campusai', 'campusai', 'notice', '校园墙', 'Shawn', '0', '/', '{\"parentMenuId\":\"2038\",\"treeName\":\"\",\"treeParentCode\":\"\",\"parentMenuName\":\"智慧园区\",\"treeCode\":\"\"}', 'admin', '2025-09-17 13:45:26', '', '2025-09-17 13:46:30', ''),
