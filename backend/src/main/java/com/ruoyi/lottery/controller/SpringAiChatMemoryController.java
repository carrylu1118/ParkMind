...
import com.ruoyi.lottery.service.ISpringAiChatMemoryService;
...
public class SpringAiChatMemoryController extends BaseController
{
     ...
     * 查询会话历史列表
     */
    @RequiresPermissions("lottery:MEMORY:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出会话历史列表
     */
    @RequiresPermissions("lottery:MEMORY:export")
     ...
     * 新增保存会话历史
     */
    @RequiresPermissions("lottery:MEMORY:add")
     ...
     * 修改会话历史
     */
    @RequiresPermissions("lottery:MEMORY:edit")
    @GetMapping("/edit/{id}")
     ...
     * 删除会话历史
     */
    @RequiresPermissions("lottery:MEMORY:remove")
