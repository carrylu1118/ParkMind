...
{
    private String prefix = "lottery/record";

    @Autowired
    private ISpringAiChatRecordService springAiChatRecordService;

    @RequiresPermissions("lottery:record:view")
    @GetMapping()
     ...
     * 查询会话记录列表
     */
    @RequiresPermissions("lottery:record:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出会话记录列表
     */
    @RequiresPermissions("lottery:record:export")
     ...
     * 新增保存会话记录
     */
    @RequiresPermissions("lottery:record:add")
     ...
     * 修改会话记录
     */
    @RequiresPermissions("lottery:record:edit")
    @GetMapping("/edit/{id}")
     ...
     * 删除会话记录
     */
    @RequiresPermissions("lottery:record:remove")
